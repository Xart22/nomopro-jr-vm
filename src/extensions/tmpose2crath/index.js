...
class Scratch3TMPose2ScratchBlocks {
    constructor(runtime) {
        ...
        this.canvas.style.width = this.firstLayer.style.width;
        this.canvas.style.height = this.firstLayer.style.height;
                ...
                blocks: [
                    {
                        ...
                        text: Message.when_received_pose_label_block[
                            this.locale
                        ],
                    ...
                    },
                    {
                        ...
                        text: Message.pose_classification_model_url[
                            this.locale
                        ],
