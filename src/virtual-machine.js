...
class VirtualMachine extends EventEmitter {
    constructor() {
        ...
        this.runtime.on(
            Runtime.SCRATCH_EXTENSION_FIELD_ADDED,
        ...
        this.runtime.on(
            Runtime.DEVICE_EXTENSION_ADDED,
        ...
        this.runtime.on(
            Runtime.PERIPHERAL_REALTIME_CONNECTION_LOST_ERROR,
            (data) =>
                this.emit(
                    Runtime.PERIPHERAL_REALTIME_CONNECTION_LOST_ERROR,
                    data
        ...
        this.runtime.on(
            Runtime.PERIPHERAL_SET_UPLOAD_ABORT_ENABLED,
            (enabled) =>
    ...
    installDeviceExtensionsSync() {
        if (this.runtime._pendingDeviceExtensions) {
            ...
            return this.extensionManager
                .loadDeviceExtension(
                    this.runtime._pendingDeviceExtensions.shift()
                )
    ...
    installDevice(
        ...
        if (device) {
            ...
            return this.extensionManager
                .loadDeviceURL(device, deviceType, pnpIdList)
                .then(() => targets);
        }
        return targets;
    }
