...
class OpenBlockArduinoMega2560Device {
    ...
    constructor(runtime, originalDeviceId) {
        ...
        this._peripheral = new ArduinoMega2560(
            this.runtime,
            this.DEVICE_ID,
            originalDeviceId
        );
        ...
        return [
            {
                ...
                name: formatMessage({
                    ...
                    default: "Pins",
                    description:
                        "The name of the arduino mega2560 device pin category",
                }),
                color1: "#4C97FF",
                color2: "#3373CC",
                color3: "#3373CC",
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: "Serial",
                    description:
                        "The name of the arduino mega2560 device serial category",
                }),
                color1: "#9966FF",
                color2: "#774DCB",
                color3: "#774DCB",
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoMega2560 multi serial available data length",
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoMega2560 multi serial read a byte",
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: "Data",
                    description:
                        "The name of the arduino mega2560 device data category",
                }),
                color1: "#CF63CF",
                color2: "#C94FC9",
                color3: "#BD42BD",
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoMega2560 data convert to ASCII character",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoMega2560 data convert to ASCII nubmer",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
