...
class OpenBlockArduinoK210Device {
    ...
    constructor(runtime, originalDeviceId) {
        ...
        this._peripheral = new ArduinoK210(
            this.runtime,
            this.DEVICE_ID,
            originalDeviceId
        );
                ...
                blocks: [
                    {
                        ...
                        text: formatMessage({
                            ...
                            default:
                                "serial [NO] begin baudrate [BAUD] pin RX [RX_PIN] TX [TX_PIN]",
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoK210 multi serial available data length",
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoK210 data convert to ASCII character",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoK210 data convert to ASCII nubmer",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
