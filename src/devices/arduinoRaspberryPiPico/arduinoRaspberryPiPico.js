...
class OpenBlockArduinoRaspberryPiPicoDevice {
    ...
    constructor(runtime, originalDeviceId) {
        ...
        this._peripheral = new ArduinoRaspberryPiPico(
            this.runtime,
            this.DEVICE_ID,
            originalDeviceId
        );
        ...
        return [
            {
                ...
                name: formatMessage({
                    ...
                    default: "Pins",
                    description:
                        "The name of the arduino RaspberryPiPico device pin category",
                }),
                color1: "#4C97FF",
                color2: "#3373CC",
                color3: "#3373CC",
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico set digital pin out",
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico set pwm pin out",
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    "---",
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico read digital pin",
                        }),
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico read analog pin",
                        }),
                    ...
                    "---",
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico set servo pin out",
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    "---",
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico attach interrupt",
                        }),
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico detach interrupt",
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: "Serial",
                    description:
                        "The name of the arduino RaspberryPiPico device serial category",
                }),
                color1: "#9966FF",
                color2: "#774DCB",
                color3: "#774DCB",
                ...
                blocks: [
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico multi serial begin",
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            NO: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico multi serial print",
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            NO: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico multi serial available data length",
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico multi serial read a byte",
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: "Data",
                    description:
                        "The name of the arduino RaspberryPiPico device data category",
                }),
                color1: "#CF63CF",
                color2: "#C94FC9",
                color3: "#BD42BD",
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico data constrain",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico data convert to ASCII character",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoRaspberryPiPico data convert to ASCII nubmer",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
