...
class OpenBlockArduinoEsp8266Device {
    ...
    constructor(runtime, originalDeviceId) {
        ...
        this._peripheral = new ArduinoEsp8266(
            this.runtime,
            this.DEVICE_ID,
            originalDeviceId
        );
        ...
        return [
            {
                ...
                name: formatMessage({
                    ...
                    default: "Pins",
                    description:
                        "The name of the arduino Esp8266 device pin category",
                }),
                color1: "#4C97FF",
                color2: "#3373CC",
                color3: "#3373CC",
                    ...
                    },
                    {
                        ...
                        arguments: {
                            PIN: {
                                ...
                                menu: "pwmPins",
                                defaultValue:
                                    this.DEFAULT_PWM_AND_INTERRUPT_PIN,
                            },
                            OUT: {
            ...
            },
            {
                ...
                name: formatMessage({
                    ...
                    default: "Serial",
                    description:
                        "The name of the arduino Esp8266 device serial category",
                }),
                color1: "#9966FF",
                color2: "#774DCB",
                color3: "#774DCB",
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoEsp8266 serial available data length",
                        }),
                        blockType: BlockType.REPORTER,
                        programMode: [ProgramModeType.UPLOAD],
                    },
                ...
                blocks: [
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoEsp8266 data convert to ASCII character",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            ...
                            description:
                                "arduinoEsp8266 data convert to ASCII nubmer",
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
